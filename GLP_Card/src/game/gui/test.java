...
public class test extends JPanel{
	...
	private void initialize() {
		...
		frame.setTitle("Tu n'y peux rien !");
...
//		bottom.setBounds(x, y, width, height);
		...
		Icon handCard = new ImageIcon("../resources/images/12_0.png");
		JLabel hand = new JLabel(handCard);
		hand.setBounds(80, 55, 100, 150);
		center.add(hand);
		
        Icon handCard2 = new ImageIcon("../resources/images/10_0.png");
        ButtonLabel label = new ButtonLabel(handCard2);
        label.setBounds(420, 55, 103, 150);
		center.add(label);
		//
        Icon handCard3 = new ImageIcon("../resources/images/4_3.png");
        ...
        Icon handCard4 = new ImageIcon("../resources/images/8_2.png");
